...
namespace WebComponentUtil.WCF.Post
{
    public class WCFService<Entity> : IWCFService<Entity>
    {
        ...
        private string Xml_Orders_Temp= "<orders xmlns:a=\"http://schemas.datacontract.org/2004/07/WebComponentUtil.WCF.Models\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\">{0}</orders>";
         ...
         <s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
            <s:Body>
                <GetListByQuery xmlns="http://tempuri.org/">
                    ...
                    <filters xmlns:a="http://schemas.datacontract.org/2004/07/WebComponentUtil.WCF.Models" 
                        xmlns:i="http://www.w3.org/2001/XMLSchema-instance">
                        <a:CommonFilterModel>
                            <a:Filter>=</a:Filter>
                            <a:ListValue i:nil="true" 
                    ...
                    <orders xmlns:a="http://schemas.datacontract.org/2004/07/WebComponentUtil.WCF.Models" 
                        xmlns:i="http://www.w3.org/2001/XMLSchema-instance">
                        <a:CommonOrderModel>
                            <a:Name>DicID</a:Name>
                            <a:Order>0</a:Order>
