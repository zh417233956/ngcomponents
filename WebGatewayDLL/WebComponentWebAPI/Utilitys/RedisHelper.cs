...
namespace WebComponentWebAPI.Utilitys
{
    ...
    public static class RedisHelper
    {
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        private static byte[] SerializeByte(object o)
        {
            if (o == null)
            {
                return null;
        ...
        /// <param name="stream"></param>
        /// <returns></returns>
        private static T DeserializeByte<T>(byte[] stream)
        {
            if (stream == null)
            {
                return default(T);
        ...
        //    ConnectionMultiplexer muxer = ConnectionMultiplexer.Connect(Constr);
